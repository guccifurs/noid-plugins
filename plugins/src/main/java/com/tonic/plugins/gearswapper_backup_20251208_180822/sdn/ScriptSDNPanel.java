...
public class ScriptSDNPanel extends JPanel {
    ...
    private final Supplier<SDNUserInfo> userSupplier;
    ...
    public ScriptSDNPanel(Supplier<SDNUserInfo> userSupplier) {
    ...
    private JPanel createHeader() {
        ...
        // Show username
        SDNUserInfo user = userSupplier.get();
        if (user != null && user.getDiscordName() != null) {
            JLabel userLabel = new JLabel("👤 " + user.getDiscordName());
