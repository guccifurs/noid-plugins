...
public class TriggerConfig
{
    ...
    public enum HpTargetType
    {
        ...
        HpTargetType(String displayName) { this.displayName = displayName; }
    ...
    public enum HpThresholdType
    {
        ...
        HpThresholdType(String displayName) { this.displayName = displayName; }
        public String getDisplayName() { return displayName; }
    }
    ...
    public boolean isOnlyInCombat() { return onlyInCombat; }
    public void setOnlyInCombat(boolean onlyInCombat) { this.onlyInCombat = onlyInCombat; }

    public boolean isOnlyWhenLoggedIn() { return onlyWhenLoggedIn; }
    public void setOnlyWhenLoggedIn(boolean onlyWhenLoggedIn) { this.onlyWhenLoggedIn = onlyWhenLoggedIn; }
    ...
    public TargetFilter getTargetFilter() { return targetFilter; }
    ...
    public String getTargetFilterValue() { return targetFilter.getValue(); }
    ...
    public boolean isHpIsPercentage() { return hpIsPercentage; }
    public void setHpIsPercentage(boolean hpIsPercentage) { this.hpIsPercentage = hpIsPercentage; }

    public HpTargetType getHpTargetType() { return hpTargetType; }
    ...
    public HpThresholdType getHpThresholdType() { return hpThresholdType; }
    ...
    public int getMinConsecutiveTicks() { return minConsecutiveTicks; }
    ...
    public boolean isRequireSpecialAttack() { return requireSpecialAttack; }
    public void setRequireSpecialAttack(boolean requireSpecialAttack) 
    {
        this.requireSpecialAttack = requireSpecialAttack;
    }
    
    public int getSpecialAttackThreshold() { return specialAttackThreshold; }
    ...
    public void setXpThreshold(int xpThreshold) { this.xpThreshold = Math.max(0, xpThreshold); }

    public int getMaxXpThreshold() { return maxXpThreshold; }
    ...
    public void setSkillFilter(String skillFilter) { this.skillFilter = skillFilter != null ? skillFilter : "any"; }

    public int getDamageThreshold() { return damageThreshold; }
    public void setDamageThreshold(int damageThreshold) { this.damageThreshold = Math.max(0, damageThreshold); }

    public String getDamageType() { return damageType; }
    public void setDamageType(String damageType) { this.damageType = damageType != null ? damageType : "any"; }

    public double getStatusThreshold() { return statusThreshold; }
    public void setStatusThreshold(double statusThreshold) { this.statusThreshold = Math.max(0.0, statusThreshold); }

    public String getAreaName() { return areaName; }
    public void setAreaName(String areaName) { this.areaName = areaName != null ? areaName : ""; }

    public int getX1() { return x1; }
    public void setX1(int x1) { this.x1 = Math.max(-1, x1); }

    public int getY1() { return y1; }
    public void setY1(int y1) { this.y1 = Math.max(-1, y1); }

    public int getX2() { return x2; }
    public void setX2(int x2) { this.x2 = Math.max(-1, x2); }

    public int getY2() { return y2; }
    public void setY2(int y2) { this.y2 = Math.max(-1, y2); }
    ...
    {
        // Core validation
        if (cooldownMs < 0 || cooldownMs > 60000) return false;
        
        // Animation validation
        if (animationId < -1) return false;
        
        // HP validation
        if (hpIsPercentage && (hpThreshold < 0.0 || hpThreshold > 100.0)) return false;
        if (!hpIsPercentage && hpThreshold < 0.0) return false;
        
        // Location validation (if specified)
        if (x1 != -1 && y1 != -1 && x2 != -1 && y2 != -1)
        {
            if (x1 > x2 || y1 > y2) return false; // Invalid rectangle
        }
