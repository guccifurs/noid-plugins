...
public class GearSwapperOverlay extends Overlay {
    ...
    public GearSwapperOverlay(Client client, GearSwapperPlugin plugin, GearSwapperConfig config) {
        ...
        // Load freeze icons gracefully - they may not exist
        BufferedImage tempFreezeIcon = null;
        BufferedImage tempFreezeImmuneIcon = null;
        try {
            tempFreezeIcon = ImageUtil.loadImageResource(GearSwapperOverlay.class, "freeze.png");
        } catch (Exception ignored) {
        }
        try {
            tempFreezeImmuneIcon = ImageUtil.loadImageResource(GearSwapperOverlay.class, "freezeimmune.png");
        } catch (Exception ignored) {
        }

        this.freezeIcon = tempFreezeIcon;
        this.freezeImmuneIcon = tempFreezeImmuneIcon;
