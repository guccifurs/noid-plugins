...
public class TriggerCreationDialog extends JDialog
{
    ...
    private JPanel createHPConfigPanel()
    {
        ...
        System.out.println("[Trigger Creation] Added special attack checkbox to HP panel: " + requireSpecialAttackCheckBox.isVisible());
        
        // Special attack slider (indented)
        gbc.gridx = 0; gbc.gridy = 6; gbc.gridwidth = 1; gbc.insets = new Insets(5, 20, 5, 5);
    ...
    private JPanel createXPConfigPanel()
    {
        ...
        // Special attack slider (indented)
        gbc.gridx = 0; gbc.gridy = 3; gbc.gridwidth = 1; gbc.insets = new Insets(5, 20, 5, 5);
        panel.add(createLabel("Min Special %:"), gbc);
        gbc.gridx = 1; gbc.fill = GridBagConstraints.HORIZONTAL; gbc.weightx = 1.0;
    ...
    private void saveTrigger()
    {
        try
        {
            ...
            if ("Gear Swap".equals(selectedActionType))
            {
                ...
                {
                    JOptionPane.showMessageDialog(this, "Please select a loadout to execute", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            else if ("Move".equals(selectedActionType))
            {
                try
                {
                    ...
                    {
                        JOptionPane.showMessageDialog(this, "Please enter number of tiles to move", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    {
                        JOptionPane.showMessageDialog(this, "Move tiles must be between 1 and 10", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
                catch (NumberFormatException e)
                {
                    JOptionPane.showMessageDialog(this, "Invalid move tiles format", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            ...
            if (type == TriggerType.ANIMATION)
            {
                ...
                {
                    JOptionPane.showMessageDialog(this, "Invalid animation ID or cooldown", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            else if (type == TriggerType.HP)
            {
                try
                {
                    ...
                    if (hpText.isEmpty())
                    {
                        JOptionPane.showMessageDialog(this, "HP threshold cannot be empty", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    if (hpValue < 0)
                    {
                        JOptionPane.showMessageDialog(this, "HP threshold cannot be negative", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    if (!cooldownText.isEmpty()) {
                        try {
                            ...
                            JOptionPane.showMessageDialog(this, "Invalid cooldown format", "Error", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
                    ...
                    if (!distanceText.isEmpty()) {
                        try {
                            ...
                            JOptionPane.showMessageDialog(this, "Invalid distance format", "Error", JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    }
                }
                ...
                {
                    JOptionPane.showMessageDialog(this, "Invalid HP threshold format", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                catch (Exception e)
                {
                    JOptionPane.showMessageDialog(this, "Error saving HP trigger: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            else if (type == TriggerType.XP)
            {
                try
                {
                    ...
                    if (xpText.isEmpty())
                    {
                        JOptionPane.showMessageDialog(this, "XP threshold cannot be empty", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    if (xpValue < 0)
                    {
                        JOptionPane.showMessageDialog(this, "XP threshold cannot be negative", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                ...
                {
                    JOptionPane.showMessageDialog(this, "Invalid XP threshold format", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                catch (Exception e)
                {
                    JOptionPane.showMessageDialog(this, "Error saving XP trigger: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
            }
            ...
            else if ("Move".equals(selectedActionType))
            {
                try
                {
                    ...
                    com.tonic.plugins.gearswapper.triggers.actions.MoveAction moveAction = new com.tonic.plugins.gearswapper.triggers.actions.MoveAction(tilesToMove);
            ...
            JOptionPane.showMessageDialog(this, "Trigger created successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            dispose();
            
        }
        catch (Exception e)
        {
            JOptionPane.showMessageDialog(this, "Error creating trigger: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void testTrigger()
    {
            ...
            new Timer(30000, e -> {
                try
                {
                    ...
                    if (!removed)
                    {
                        ...
                        System.out.println("[Test Trigger] Test trigger " + testTrigger.getId() + " was already removed or not found");
                    }
                }
                catch (Exception ex)
                {
        ...
        {
            JOptionPane.showMessageDialog(this, "Error creating test trigger: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
